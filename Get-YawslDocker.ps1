<#
.SYNOPSIS
    Install yawsldocker as a WSL distribution.
.DESCRIPTION
    This script downloads the yawsldocker Docker image and imports it as a WSL distribution.
.PARAMETER Version
    The version of the Docker image to install.
    If not specified, will check $env:YAWSLDOCKER_VERSION, then default to 'latest'.
.PARAMETER Name
    The name of the WSL distribution to create.
    If not specified, will check $env:YAWSLDOCKER_NAME, then default to 'yawsldocker'.
.PARAMETER InstallDir
    The directory where the WSL distribution will be installed.
    If not specified, will check $env:YAWSLDOCKER_DIR, then default to '$env:LOCALAPPDATA\yawsldocker'.
.PARAMETER NoProxy
...
.LINK
    https://github.com/antoinemartin/yawsldocker
#>
[CmdletBinding()]
param(
    [String] $Version,
...
function Install-YawslDocker {
    Write-InstallInfo 'Installing yawsldocker...'
    ...
    $layerFile = Join-Path $tempDir "yawsldocker-$tag.tar.gz"
...
function Write-DebugInfo {
    ...
    Write-Verbose "`$env:YAWSLDOCKER_VERSION: $env:YAWSLDOCKER_VERSION"
    Write-Verbose "`$env:YAWSLDOCKER_NAME: $env:YAWSLDOCKER_NAME"
    Write-Verbose "`$env:YAWSLDOCKER_DIR: $env:YAWSLDOCKER_DIR"
